    ...
    chapters: [
       {
        ...
        },
        {
            ...
            description: 'In this essay, I will be examining three novels from three different novels from different points in American history to investigate how these authors depict African-American movement within these novels, and compare that to the picture of African-American life painted by local color stories. Specifically, I will be looking at a possible relationship between black economic progress, measured by purchases by African-Americans within the novel, and movement. These novels are <em>Their Eyes Were Watching God</em> by Zora Neale Hurston, <em>The Color Purple</em> by Alice Walker, and <em>Salvage The Bones</em> by Jesmyn Ward. ',
            location: {
        ...
        },
{
        ...
        },
        {
            ...
            description: 'Jesmyn Ward’s 2011 novel, <em>Salvage The Bones</em> follows Esch, a black teenager navigating an unwanted pregnancy. The story follows Esch’s family as they prepare for Hurricane Katrina and the devastation that will follow. Esch’s brother Skeetah owns a Pitbull that he dogfights named China. Skeetah is obbsesed with taking care of China, both because he is extremely attached to her, and because he wants to sell her pups to make money. Skeetah taking care of China does create friction, as Skeetah has to take money from his father to spend money on her, saying on page 29, "On a few of Daddys drunk nights when he is down at the Oaks nodding off to the blues, Ive seen Skeet walking out of Daddys room with his hands balled into stealing fists in his pockets. I keep expecting Daddy to wake one morning to find some of his money missing. He would be out in the hallway, yelling for Skeetah, throwing off anger and alcohol like steam, but we have been lucky. That has not happened yet." China’s motherhood in many ways parallels Esch’s, with both navigating the trials and tribulations of motherhood.',
            location: {
